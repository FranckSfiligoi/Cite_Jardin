...
//file<geometry> osmfile <- file<geometry> (osm_file("../includes/malpasse_stjust.osm", filtering));
file<geometry> osmfile <- file<geometry> (osm_file("../includes/aix_cuques_facs.osm", filtering));
...
/* 	ask cell3 {
	...
	create monde {
	 ...
	 save monde format: shp to: "monde.shp" ;
		
save building to:"../results/buildings_marseille.shp" format:"shp" attributes: ["ID":: int(self)]; 
save road to:"../results/roads_marseille.shp" format:"shp" attributes: ["ID":: int(self)]; 
save water to:"../results/waterways_marseille.shp" format:"shp" attributes: ["ID":: int(self)]; 
save monde to:"../results/monde_marseille.shp" format:"shp" attributes: ["ID":: int(self)]; 
//save cell3 to:"../results/grid_marseille.csv" type:"csv" rewrite: true;
...
species monde
{
	...
	aspect default
	{
		draw shape wireframe:true color: #red width:3;
	}
